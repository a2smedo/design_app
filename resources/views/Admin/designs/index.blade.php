        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <div class="card-tools">
                <a href="{{ url('/dashboard/designs/create') }}" class="btn btn-primary btn-sm"
                  title="Add new Design">Add new</a>
              </div>
            </div>
          </div>
        </div>
